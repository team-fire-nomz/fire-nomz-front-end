    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route
            path="/addrecipe"
            element={<AddRecipe isLoggedIn={isLoggedIn} token={token} />}
          />
          <Route
            path="/recipe/:id"
            element={
          ...
          />
          <Route
            path="/recipe/:id/notes"
            element={<Notes isLoggedIn={isLoggedIn} token={token} />}
          />
          <Route
            path="/recipe/:recipeId/edit"
            element={<Edit isLoggedIn={isLoggedIn} token={token} />}
          />
          <Route
            path="/recipes/:id/feedback"
            element={<Feedback isLoggedIn={isLoggedIn} token={token} />}
          />
        </Route>
      </Routes>
    </BrowserRouter>
